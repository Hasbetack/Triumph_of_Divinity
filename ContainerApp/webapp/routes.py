...
from webapp.utils import load_changelog_json, load_datacard_json, filter_datacards_by_faction, filter_datacards_by_keyword
...
def datacards():
    datacards_data, all_factions, all_keywords = load_datacard_json()
